...
public class HeartsGame implements Serializable{
	...
	Boolean debug_valid = false; //parameter for debug statements
	...
	public class Trick implements Serializable {
		...
		public void computeWinner() {
			...
			if(debug_valid) System.out.println("=====  " + winner + " wins!");
			...
			if(debug_valid) System.out.println("=====  " + winner + " earns " + points + " points!");
			...
			synchronized(HeartsGame.this) {
				for(String s: players) {
					if(handScore.containsKey(s))
						...
						if(debug_valid) System.out.println(s + " scored " + (totalScore.get(s)+handScore.get(s)) );
				}
			}
